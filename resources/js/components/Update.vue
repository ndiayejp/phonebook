    ...
    <div class="modal" :class="openmodal">
        ...
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title">{{ list.name }} mise à jour</p>
            ...
            <footer class="modal-card-foot">
                <button class="button is-success" @click='update'>Mettre à jour</button>
...
export default {
  ...
  methods: {
    ...
    update() {
      axios
        .put(`/phonebook/${this.list.id}`, this.$data.list)
        .then(response => {
          this.close();
        })
